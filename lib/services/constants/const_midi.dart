...
Map<int, Perc> gm2PercStandard = {
  ...
  32: Perc('Square Click 54', PercType.sfx),
  33: Perc('Metronome Click', PercType.sfx),
  34: Perc('Metronome Bell', PercType.sfx),
  35: Perc('Acoustic Bass Drum', PercType.kick),
  36: Perc('Bass Drum 1', PercType.kick),
  37: Perc('Side Stick', PercType.snare),
  38: Perc('Acoustic Snare', PercType.snare),
  39: Perc('Hand Clap', PercType.snare),
  40: Perc('Electric Snare', PercType.snare),
  41: Perc('Low Floor Tom', PercType.tom),
  42: Perc('Closed Hi Hat', PercType.hat),
  43: Perc('High Floor Tom', PercType.tom),
  44: Perc('Pedal Hi-Hat', PercType.hat),
  45: Perc('Low Tom', PercType.tom),
  46: Perc('Open Hi-Hat', PercType.hat),
  47: Perc('Low-Mid Tom', PercType.tom),
  48: Perc('Hi-Mid Tom', PercType.tom),
  49: Perc('Crash Cymbal 1', PercType.cymbal),
  50: Perc('High Tom', PercType.tom),
  51: Perc('Ride Cymbal 1', PercType.cymbal),
  52: Perc('Chinese Cymbal', PercType.cymbal),
  53: Perc('Ride Bell', PercType.cymbal),
  54: Perc('Tambourine', PercType.perc),
  55: Perc('Splash Cymbal', PercType.cymbal),
  56: Perc('Cowbell', PercType.sfx),
  57: Perc('Crash Cymbal 2', PercType.cymbal),
  58: Perc('Vibraslap', PercType.perc),
  59: Perc('Ride Cymbal 2', PercType.cymbal),
  60: Perc('Hi Bongo', PercType.handDrum),
  61: Perc('Low Bongo', PercType.handDrum),
  62: Perc('Mute Hi Conga', PercType.handDrum),
  63: Perc('Open Hi Conga', PercType.handDrum),
  64: Perc('Low Conga', PercType.handDrum),
  65: Perc('High Timbale', PercType.handDrum),
  66: Perc('Low Timbale', PercType.handDrum),
  67: Perc('High Agogo', PercType.sfx),
  68: Perc('Low Agogo', PercType.sfx),
  ...
  76: Perc('Hi Wood Block', PercType.perc),
  77: Perc('Low Wood Block', PercType.perc),
  78: Perc('Mute Cuica', PercType.sfx),
  79: Perc('Open Cuica', PercType.sfx),
  80: Perc('Mute Triangle', PercType.sfx),
  81: Perc('Open Triangle', PercType.sfx),
  ...
  86: Perc('Mute Surdo', PercType.handDrum),
  87: Perc('Open Surdo', PercType.handDrum),
};
